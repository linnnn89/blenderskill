...
Create reusable masters in `MAT-` prefix:

| Master | Base Setup |
|--------|------------|
| MAT-Metal_Base | Principled: Metallic 1, adjustable Roughness |
| MAT-Plastic_Base | Principled: Metallic 0, Specular 0.5 |
| MAT-Fabric_Base | Principled + Sheen |
| MAT-Glass_Base | Principled: Transmission 1, IOR 1.45 |
| MAT-Emissive_Base | Principled: Emission strength variable |
| MAT-Organic_Base | Subsurface scattering enabled |
...
- Name materials `MAT-[Surface]_[Descriptor]`
