...
Naming: `T_[Asset]_[Map]` per `${COMMANDCODE_SKILL_DIR}/references/naming-conventions.md`
...
See `${COMMANDCODE_SKILL_DIR}/references/polycount-budgets.md` texture section.
