...
### Geometry
- [ ] Triangle count vs budget (`${COMMANDCODE_SKILL_DIR}/references/polycount-budgets.md`)
...
|-------|-----------|-----------|
| Full validation | `${COMMANDCODE_SKILL_DIR}/references/validation-checklist.md` | Final gate |
| Polycount budgets | `${COMMANDCODE_SKILL_DIR}/references/polycount-budgets.md` | Budget setting |
