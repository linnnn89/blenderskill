...
See `${COMMANDCODE_SKILL_DIR}/references/polycount-budgets.md` — apply 50–90% reduction.
...
| Asset budgets | `${COMMANDCODE_SKILL_DIR}/references/polycount-budgets.md` | Budget setting |
