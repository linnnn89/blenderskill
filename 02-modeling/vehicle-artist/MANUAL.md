...
| Object | Why |
|--------|-----|
| `GEO-Vehicle_Body` | Main shell |
| `GEO-Vehicle_Wheel_*` | Spin / steer |
| `GEO-Vehicle_Glass` | Transparency / sorting |
| `GEO-Vehicle_Light_*` | Emissive materials |
| `GEO-Vehicle_Interior` | Cull on distant LODs |
