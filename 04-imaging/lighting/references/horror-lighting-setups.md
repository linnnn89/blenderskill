...
```
LGT-Key: Area light, 6500K, strength 50W, size 1.2m × 0.1m (tube shape)
...
```
LGT-Key: Point light, 2800K, strength 100W
...
```
LGT-Key: Area light, 5000K green tint, strength 20W
Position: Low, facing into room from TV mesh
Emission: MAT-Emissive_Screen on TV face
Room: Otherwise dark
```
...
```
LGT-Accent: Spot, green, strength 30W, narrow angle
...
LGT-Rim: Area, 8000K, strength 20W through window opening
