...
```
LGT-Key: Area 1m², 45° elevation, 30° azimuth, 5500K, strength 500W
LGT-Fill: Area 2m², opposite side, 5500K, strength 150W (30% key)
LGT-Rim: Spot, behind subject 135°, 3200K warm, strength 300W
```

## Product Hero Shot

```
LGT-Key: Large area softbox simulation (2m²)
LGT-Rim: Two spots L/R behind for edge definition
...
```
LGT-Key: Area, fixed relative to camera (parent to camera)
LGT-Fill: World HDRI studio neutral
LGT-Rim: Behind asset, subtle
