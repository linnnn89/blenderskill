...
- `${COMMANDCODE_SKILL_DIR}/references/validation-checklist.md`
- `${COMMANDCODE_SKILL_DIR}/references/visual-match-checklist.md` (reference tasks)
- `${COMMANDCODE_SKILL_DIR}/references/naming-conventions.md`
- `${COMMANDCODE_SKILL_DIR}/references/polycount-budgets.md`
